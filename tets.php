        ...
        <div class="thim-link-login thim-login-popup<?php echo esc_attr($class_sub_info); ?>">
            ...
            if (is_user_logged_in()) {
                ...
                if ($registration_enabled && ($register_text || $show_icon_register)) {
                    echo '<a class="register js-show-popup" href="https://abdelrahmanelbaz.com/user-register/">';
    ...
    public function display_login_popup_form()
    {
        ...
        ?>
            <div id="thim-popup-login">
                <div class="popup-login-wrapper<?php echo (!empty($settings['shortcode'])) ? ' has-shortcode' : ''; ?>">
                    <div class="thim-login-container">
                        ...
                        <div class="thim-popup-inner">
                            <div class="thim-login">
                                ...
                                <?php
                                // Add the phone number field to the login form
                                $args = array(
                                    'label' => __('Phone Number', 'textdomain'),
                                    'input' => 'text',
                                    'value' => esc_attr(wp_unslash($_POST['phone'])),
                                    'required' => true,
                                );
                                ?>
                                <p class="form-row form-row-wide">
                                    <label for="phone"><?php esc_html_e('Phone Number', 'textdomain'); ?> <span class="required">*</span></label>
                                    <input type="text" class="input-text" name="phone" id="phone" value="<?php echo esc_attr(wp_unslash($_POST['phone'])); ?>" placeholder="<?php esc_attr_e('Enter your phone number', 'textdomain'); ?>" />
                                </p>
                                ...
                                if ($registration_enabled) {
                                    echo '<p class="link-bottom">' . esc_html__('Not a member yet? ', 'eduma') . ' <a class="register" href="https://abdelrahmanelbaz.com/user-register/">' . esc_html__('Register now', 'eduma') . '</a></p>';
                                }
                                ?>
